...
// var governancePolicy *types.GovernancePolicy
...
// func InitGovernancePolicy() *types.GovernancePolicy {
// 	return &types.GovernancePolicy{
...
// func NewGovernance(signers []common.Address, threshold uint8, version string) *types.GovernancePolicy {
// 	return &types.GovernancePolicy{
// 		Signers:   signers,
// 		Threshold: threshold,
// 	}
...
// func GetGovernancePolicy() *types.GovernancePolicy {
